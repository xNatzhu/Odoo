# -*- coding: utf-8 -*-
{
    'name': "my_module", # El nombre del modulo.
    ...
    'version': '0.1', # La version se puede incrementar a medidas que se vayan subiendo las actualizaciones. El primer numero es para los mayores, y el segundo para los intermedio.
