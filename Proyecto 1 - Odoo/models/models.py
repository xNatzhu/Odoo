...
class Aparcamiento(models.Model): #Herencia para heredar los metodos que se encuentran en Model.
    _name = 'garaje.Aparcamiento' #define al modelo real. #Si queremos buscar un aparcamiento se debe buscar por garaje.aparcamiento
    _description = 'Permite definir las caracteristicas de un aparcamiento.' 
    name = fields.Char('Direccion', required=True) #Definimos el campo, descripcion o el texto que nos va ayudar a identificar al objeto cuando navegamos o cuando buscamos
